...
<html>
<head>
<title> Details For Insertion</title>
...
#footer {
    ...
    <form method="post" action="insert3.jsp">  
        ...
        This page is compatible in Google Chrome and Microsoft Edge.    
		   ...
		   <tr><td class="h1"><u>DSC Details To Be Inserted</u></td></tr>
		   </table><br>
   ...
   { 
	...
	//out.println("3"); 
	  ...
	  rs0.close();
		...
		<tr>
		<td class="link"><font size="3px"><a href="insert.jsp"><b>GOBACK</b></a></font></td><td></td><td></td>
		...
		<tr><th class="h2">Grade : </th><td class="h2" ><%= v_grade %></td></tr>
